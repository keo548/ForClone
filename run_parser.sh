...
if [[ $1 == "java" ]]; then
    cd grammar
    $antlr4 C1Parser.g4 -o ../build
    cd ../build
    javac *.java
    $grun C1Parser tokens -tokens
elif [[ $1 == "cpp" ]]; then
    cd grammar
    $antlr4 C1Parser.g4 -Dlanguage=Cpp -o ../build
    cd ../build
    ...
    #g++ -std=c++17 ../test/parser.cpp C1parser.cpp -I../include/antlr4-runtime-4.13.1 -I. -lantlr4-runtime -o c1parser
    #./c1lexer
    g++ -std=c++17 ../test/parser.cpp C1parser.cpp -I../include/antlr4-runtime-4.13.1 -I. -lantlr4-runtime -o c1parser
    ./c1lexer
fi
